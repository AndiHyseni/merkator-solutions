    ...
    <div className="page home-page">
      ...
      <main className="content">
        <section className="hero">
          <p className="hero-kicker">Clarity is a competetive advantage.</p>
...
function ContactPage() {
  ...
  async function handleSubmit(event) {
    ...
    if (!serviceId || !templateId || !publicKey) {
      setFeedback({
        type: 'error',
        message: 'Email setup is incomplete. Add EmailJS keys in your .env file.',
      })
      return
    }
        ...
        <section className="contact-grid">
          <form ref={formRef} className="contact-form-card" onSubmit={handleSubmit}>
            ...
            <input
              ...
              required
            />
            <input type="tel" name="user_phone" placeholder="Phone" aria-label="Phone" />
            <textarea
              name="message"
